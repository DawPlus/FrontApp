...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.reducers.preLayout,
        collapseMenu: state.reducers.collapseMenu,
        layoutType: state.reducers.layoutType,
        navBackColor: state.reducers.navBackColor,
        navBackImage: state.reducers.navBackImage,
        navIconColor: state.reducers.navIconColor,
        navBrandColor: state.reducers.navBrandColor,
        layout6Background: state.reducers.layout6Background,
        layout6BackSize: state.reducers.layout6BackSize,
        rtlLayout: state.reducers.rtlLayout,
        navFixedLayout: state.reducers.navFixedLayout,
        boxLayout: state.reducers.boxLayout,
        navDropdownIcon: state.reducers.navDropdownIcon,
        navListIcon: state.reducers.navListIcon,
        navActiveListColor: state.reducers.navActiveListColor,
        navListTitleColor: state.reducers.navListTitleColor,
        navListTitleHide: state.reducers.navListTitleHide
    }
};
