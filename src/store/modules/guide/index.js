...
const INITIALIZE = 'guide/INITIALIZE';
const INITIALIZE_FORM = 'guide/INITIALIZE_FORM';
const CHANGE_FIELD = 'guide/CHANGE_FIELD';


const [LIST, LIST_SUCCESS, LIST_FAILURE]       = createRequestActionTypes('guide/LIST');
const [NEW, NEW_SUCCESS, NEW_FAILURE] = createRequestActionTypes('guide/NEW');
const [DELETE, DELETE_SUCCESS, DELETE_FAILURE] = createRequestActionTypes('guide/DELETE');
...
export function* guideSaga() {
  ...
  yield takeLatest(NEW, createRequestSaga(NEW, API.newGuide));
